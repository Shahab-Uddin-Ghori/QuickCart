      ...
      <nav className="flex-no-wrap  relative flex w-full  items-center justify-between bg-white shadow-md py-2 shadow-dark-mild  lg:flex-wrap lg:justify-start lg:py-4">
        <div className="flex w-full flex-wrap sm:px-10 mx-5 items-center justify-between">
          ...
          <div className="relative flex items-center">
            ...
            <Link
              to="/ItemCart"
              className="relative me-4 text-gray-600 hover:text-gray-950"
            >
              ...
              {cartItems.length > 0 && (
                <span className="absolute z-[100] top-[-6px] right-[-6px] inline-flex items-center justify-center w-5 h-5 text-sm font-medium text-white bg-sky-600 rounded-full">
                  {cartItems.length} {/* Display the count directly */}
                </span>
              )}
            </Link>
